...
function addChapter(event) {
  ...
  for (
    var i = 0;
    i < document.getElementsByClassName("chapter_div").length;
    i++
  ) {
    if (document.getElementsByClassName("heading")[i] != null) {
      if (
        document.getElementsByClassName("heading")[i].checkValidity() == false
      ) {
        document.getElementsByClassName("error_heading")[i].innerHTML =
          "Not Valid!";
        document.getElementsByClassName("error_heading")[i].style =
          "color: red;";
        error = 1;
        if (focus_on == null) {
          document
      ...
      if (
        document.getElementsByClassName("description")[i].checkValidity() ==
        false
      ) {
        document.getElementsByClassName("error_description")[i].innerHTML =
          "Not Valid!";
        document.getElementsByClassName("error_description")[i].style =
          "color: red;";
        error = 1;
        if (focus_on == null) {
          document
      ...
      if (
        document.getElementsByClassName("content")[i].checkValidity() == false
      ) {
        document.getElementsByClassName("error_content")[i].innerHTML =
          "Not Valid!";
        document.getElementsByClassName("error_content")[i].style =
          "color: red;";
        error = 1;
        if (focus_on == null) {
          document
      ...
      if (
        document.getElementsByClassName("youtube")[i].checkValidity() == false
      ) {
        document.getElementsByClassName("error_youtube")[i].innerHTML =
          "Not Valid!";
        document.getElementsByClassName("error_youtube")[i].style =
          "color: red;";
        error = 1;
        if (focus_on == null) {
          document
            .getElementsByClassName("youtube")
            [i].scrollIntoView({ block: "center" });
          focus_on = "youtube";
        }
      } else {
...
function createDescriptionPage() {
  ...
  for (
    ...
    if (document.getElementsByClassName("heading")[i] != null) {
      let chapter_add = {};
      chapter_add["heading"] = document.getElementsByClassName("heading")[
        i
      ].value;
      chapter_add["description"] = document.getElementsByClassName(
        "description"
      )[i].value;
      chapter_add["content"] = document.getElementsByClassName("content")[
        i
      ].value;
      chapter_add["youtube"] = document.getElementsByClassName("youtube")[
        i
      ].value;
  ...
  div.innerHTML +=
    '<div class="container-fluid container-fluid1"><img src="/media/images/icon.png" class="icon1">' +
  ...
  document
    ...
    .setAttribute("onclick", "createDifficultyLevelPage();");
...
function createChapterPage() {
  ...
  div.innerHTML +=
    '<div id="chapter_main_div" ><div style="color: black;" class="chapter_div" class="current_chapter" id="chapter_div_0">' +
  ...
  if (chapter_innerHTML != "") {
    document.getElementById("chapter_main_div").innerHTML =
      "<br><br>" + chapter_innerHTML;
  } else {
    div.innerHTML +=
      '<button id="chapter_add_button" type="button" class="btn btn-primary" style="float: right;" onclick="addChapter()">Add Chapter</button><button id="chapter_right_button" type="button" class="btn btn-primary" style="float: right;" onclick="createLanguagesPage()">Next</button><button id="chapter_left_button" type="button" class="btn btn-primary" style="float: left;" onclick="createDescriptionPage()">Previous</button></div></div>';
  }
  if (document.getElementById("heading") != null) {
    for (
      ...
      document.getElementsByClassName("heading")[i].value =
        chapters[i]["heading"];
      document.getElementsByClassName("description")[i].value =
        chapters[i]["description"];
      document.getElementsByClassName("content")[i].value =
        chapters[i]["content"];
      document.getElementsByClassName("youtube")[i].value =
        chapters[i]["youtube"];
    }
  }
}
...
function createLanguagesPage() {
  ...
  div.innerHTML +=
    '<select id="selectpicker" multiple data-live-search="true" style="display: block;color: black;">' +
    "{% for language in languages %}" +
    "<option>{{language}}</option>{% endfor %}</select>";
  div.innerHTML +=
    '<button id="chapter_right_button" type="button" class="btn btn-primary" style="float: right;" onclick="createDifficultyPage()">Next</button><button id="chapter_left_button" type="button" class="btn btn-primary" style="float: left;" onclick="createChapterPage()">Previous</button>';
...
function createDifficultyPage() {
  ...
  div.setAttribute("class", "jumbotron text-center");
  div.innerHTML +=
    "<h2 style='color: black;'> ADD DIFFICULTY LEVEL FOR THE PROJECT</h2>";
  div.innerHTML += '<div style="color: black;">';
  div.innerHTML +=
    '<input class="difficulty_radio_input" type="radio" id="easy" name="" value="EASY" checked="checked">' +
  ...
  div.innerHTML +=
    '<button id="difficulty_right_button" type="button" class="btn btn-primary" style="float: right;" onclick="createOverviewPage()">Next</button><button id="chapter_left_button" type="button" class="btn btn-primary" style="float: left;" onclick="createLanguagesPage()">Previous</button>' +
    "</div>";
}
...
function createOverviewPage() {
  if (document.getElementsByClassName("difficulty_radio_input") != null) {
    for (
      var i = 0;
      i < document.getElementsByClassName("difficulty_radio_input").length;
      i++
    ) {
      if (
        document.getElementsByClassName("difficulty_radio_input")[i].checked
      ) {
        difficulty_level = document.getElementsByClassName(
          "difficulty_radio_input"
        )[i].value;
      }
    }
  }
  ...
  if (document.getElementById("selectpicker_prereq") != null) {
    ...
    for (
      var i = 0;
      i < document.getElementById("selectpicker_prereq").length;
      i++
    ) {
      if (document.getElementById("selectpicker_prereq")[i].selected) {
        pre_reqs.push(
          document.getElementById("selectpicker_prereq")[i].innerHTML
        );
      }
    }
  }
  ...
  div.innerHTML +=
    ...
    "<input id='overview_input' type='text' style='color: black;' value='" +
    overview +
    "'> " +
    '<button type="button" class="btn btn-primary" style="float: right;" onclick="createPreReqsPage()">Next</button><button type="button" class="btn btn-primary" style="float: left;" onclick="createDifficultyPage()">Previous</button>';
...
function createPreReqsPage() {
  ...
  div.innerHTML +=
    '<select id="selectpicker_prereq" multiple data-live-search="true" style="display: block;color: black;">' +
    "{% for pre_req in pre_reqs %}<option>{{pre_req}}</option>{% endfor %}</select>";

  div.innerHTML +=
    '<button id="chapter_right_button" type="button" class="btn btn-primary" style="float: right;" onclick="createImagePage()">Next</button><button id="chapter_left_button" type="button" class="btn btn-primary" style="float: left;" onclick="createOverviewPage()">Previous</button>';
...
function createImagePage() {
  if (document.getElementsByClassName("time_radio_input") != null) {
    for (
      var i = 0;
      i < document.getElementsByClassName("time_radio_input").length;
      i++
    ) {
      if (document.getElementsByClassName("time_radio_input")[i].checked) {
        no_of_hours = document.getElementsByClassName("time_radio_input")[i]
          .value;
      }
    }
  }
  ...
  div.innerHTML +=
    '<button id="chapter_right_button" type="button" class="btn btn-primary" style="float: right;" onclick="createNumberOfHours()">Next</button><button id="chapter_left_button" type="button" class="btn btn-primary" style="float: left;" onclick="createPreReqsPage()">Previous</button>';
}
...
function createNumberOfHours() {
  ...
  div.setAttribute("class", "jumbotron text-center");
  div.innerHTML +=
    "<h2 style='color: black;'> ADD HOURS REQUIRED FOR THE PROJECT</h2>";
  div.innerHTML += '<div style="color: black;">';
  div.innerHTML +=
    '<input class="time_radio_input" checked="checked" type="radio" id="0-2" name="" value="0-2" disabled=false>' +
  ...
  div.innerHTML +=
    '<button id="difficulty_right_button" type="button" class="btn btn-primary" style="float: right;" onclick="">Create</button><button id="chapter_left_button" type="button" class="btn btn-primary" style="float: left;" onclick="createImagePage()">Previous</button>' +
    "</div>";
}
